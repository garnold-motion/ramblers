    ...
    <div className="flex flex-col landscape:flex-row h-full w-full bg-[#1a1a1a] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center w-full landscape:w-1/2 relative border-b landscape:border-b-0 landscape:border-r border-white/5 py-4 landscape:py-0">   
        ...
        <div className="flex items-center justify-center gap-6 text-gray-500 mb-2 sm:mb-4 opacity-80 shrink-0">
          <button 
            ...
            className="p-3 -m-3 hover:text-brand-org-1 transition-colors cursor-pointer hidden sm:block"
          >
            <ArrowLeft size={16} />
          </button>
            ...
            return (
              <div 
                ...
                className={`
                  ...
                  ${isToday 
                    ? 'bg-[#222] border-2 border-brand-org-1 scale-100 opacity-100' 
      ...
      <div className="flex-1 flex flex-col justify-center items-center w-full landscape:w-1/2 p-6 landscape:p-10">
        ...
        <div 
          ...
          className="relative w-full max-w-md bg-[#222] border border-white/5 rounded-[2.5rem] p-6 sm:p-8 flex items-center justify-between cursor-pointer active:scale-[0.97] hover:border-brand-org-1/40 transition-all overflow-hidden shadow-2xl group max-h-[220px] landscape:max-h-[320px] landscape:h-full"
        >
          ...
          <div className="flex-1 pl-6 sm:pl-8 z-10 flex flex-col justify-center text-left">
            ...
            <p className="text-brand-org-1 text-[10px] sm:text-xs font-black uppercase tracking-widest mb-3">
            ...
            <div className="flex items-center gap-2 text-white/40 text-[10px] font-black uppercase tracking-widest group-hover:text-brand-org-1 transition-colors">
              <span>Tasting Notes</span>
              <ArrowRight size={14} className="text-brand-org-1 group-hover:translate-x-1 transition-transform" />
            </div>
          </div>
        </div>
      </div>
